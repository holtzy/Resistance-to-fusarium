...
#---------------1.3 Préparation SNP SSR
# header du nom de "liste_des_genotypes_dans_lordre"
DIRECTORY="/gs7k1/projects/g2pop/HOLTZ_YAN_DATA/DIC2_SILUR/DART_MICROSAT_AUTRESMARKEURS"
more $DIRECTORY/liste_des_genotypes_dans_le_genotypage_Dart.txt | sed 's/ //g' | sed 's/\./_/g' | /gs7k1/projects/g2pop/HOLTZ_YAN_DATA/programmes/awk_transpose_file.sh | sed 's/ /\t/g' | sed 's/^/SNP\t/1' | sed -e 's/\(_[0-9]\t\)/_0\1/g' | sed -e 's/\(_[0-9]$\)/_0\1/g' | sed 's/_0_/_0/g' | sed 's/TT06DC/DC/g' | sed 's/_/./g' > marker_SSR_tmp

# On récupère les SSR=34 derniers du fichier.raw du dossier
tail -n 34 $DIRECTORY/genotypage_Dic2_Silur.raw | sed 's/^*//g' > tmp_marker

# on en garde seulement 10 qui ne crée pas de problème dans ma carte
for i in $(cat /gs7k1/projects/g2pop/HOLTZ_YAN_DATA/DIC2_SILUR/DART_MICROSAT_AUTRESMARKEURS/liste_SSR_clean) ; do
...
# voici la liste:
#DC38.14	DC38.22	DC38.31	DC38.40	DC38.48	DC39.12	DC39.22	DC40.09	DC42.20	DC42.27	DC42.29	DC42.30	DC42.31	DC42.32	DC42.33	DC42.34	DC42.37	DC42.42	DC42.47	DC42.50	DC42.51	DC42.52	DC42.54	DC42.56	DC44.12	DC44.18	DC44.23	DC44.29	DC44.04	DC44.40	DC44.44	DC44.09	
...
data=data=data[grep("TRIDC", data$mk_name),]
